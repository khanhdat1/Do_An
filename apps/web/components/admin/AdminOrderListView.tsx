            ...
            <tbody className="divide-y divide-slate-100">
              {state.data.items.map((order) => (
                <tr key={order.orderCode}>
                  ...
                  <td className="whitespace-nowrap px-3 py-2.5 text-slate-600">{PAYMENT_METHOD_LABEL[order.paymentMethod]}</td>
                  <td className="whitespace-nowrap px-3 py-2.5 font-bold text-slate-800">{formatPrice(order.totalAmount)}</td>
                  ...
                  <td className="whitespace-nowrap px-3 py-2.5 text-xs text-slate-500">{formatDateTime(order.createdAt)}</td>
                  <td className="whitespace-nowrap px-3 py-2.5">
